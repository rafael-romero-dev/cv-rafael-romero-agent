...
st.set_page_config(
    page_title="Sistema RAG - Asistente de CV de Rafael Romero Negrete",
    page_icon="⭐",
    layout="wide"
)

# Título
st.title("⭐ Sistema RAG - Asistente de CV de Rafael Romero Negrete")
st.divider()
...
with st.sidebar:
    ...
    st.markdown("**🤖 Modelos:**")
    st.info("Consultas: gemini-3.5-flash\nRespuestas: gemini-3.5-flash")
...
st.divider()
st.markdown(
    "<div style='text-align: center; color: #666;'>🏛️ Asistente de CV con MMR Retriever</div>", 
